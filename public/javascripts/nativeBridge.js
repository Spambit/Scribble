(function init(){
  function isCommand(command) {
    ...
    command.success = command.success ? command.success : null;
    command.error = command.error ? command.error : null;
...
NativeBridge.setBehavior = function (behavior) {
    if (!behavior.setCompleteCallback) {
        throw 'Behavior must implement setCompleteCallback';
    }

    this.behavior = behavior;
    var callback = completeCallback.bind(this);
